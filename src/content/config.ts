...
const products = defineCollection({
    ...
    faqs: z.array(reference('faqs')).optional(),
...
const categories = defineCollection({
  ...
  schema: z.object({
    id: z.string(),
    name: z.string(),
    type: z.enum(['global', 'product', 'blog']).optional(),
    isFeatured: z.boolean().optional(),
    ...
    displayMenu: z.boolean().optional(),
...
const organizations = defineCollection({
  ...
  schema: z.object({
    id: z.string(),
    name: z.string(), // Nom de l'organisation
    description: z.string().optional(), // Description de l'organisation
    logo_url: z.string().optional(), // URL du logo
    logo_alt: z.string().optional(), // Texte alternatif du logo
    contactPoints: z.array(z.object({
      type: z.enum(['email', 'phone', 'address']),
      value: z.string(),
    })).optional(), // Points de contact directement dans l'organisation
    openingHours: z.array(z.object({
      day_of_week: z.enum(['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday']),
      opening_time: z.string(), // Format HH:MM
      closing_time: z.string(), // Format HH:MM
    })).optional(), // Horaires d'ouverture directement dans l'organisation
    createdAt: z.coerce.date(),
    updatedAt: z.coerce.date(),
  }),
});
